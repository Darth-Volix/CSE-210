...
public class PersonalLoan : LoanAccount
{
    ...
    // Constructor
    public PersonalLoan(string loanPurpose) : base(string loanName, bool isClosed, int term, decimal interestRate, decimal loanAmount, decimal monthlyPayment, decimal balance, int dueDate, DateTime openDate, DateTime? closeDate, List<Transaction> transactions)
    {
